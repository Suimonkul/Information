...
public class ItAsyncTask extends AsyncTask<String, String, Elements> {
    ...
    public ItAsyncTask(Activity activity, TextView moreInformation, TextView h1title, ImageView im1) {
