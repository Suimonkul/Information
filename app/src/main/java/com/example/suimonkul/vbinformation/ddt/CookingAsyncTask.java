...
public class CookingAsyncTask extends AsyncTask<String, String, Elements> {
    ...
    public CookingAsyncTask(Activity activity, TextView moreInformation, TextView h1title, ImageView im1) {
